...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { date: @season.date, description: @season.description, number: @season.number, serial_id: @season.serial_id }
    end
  ...
  test "should update season" do
    patch :update, id: @season, season: { date: @season.date, description: @season.description, number: @season.number, serial_id: @season.serial_id }
    assert_redirected_to season_path(assigns(:season))
  end
