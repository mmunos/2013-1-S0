...
class SerialsControllerTest < ActionController::TestCase
  ...
  test "should create serial" do
    assert_difference('Serial.count') do
      post :create, serial: { date: @serial.date, description: @serial.description, genre: @serial.genre, name: @serial.name }
    end
  ...
  test "should update serial" do
    patch :update, id: @serial, serial: { date: @serial.date, description: @serial.description, genre: @serial.genre, name: @serial.name }
    assert_redirected_to serial_path(assigns(:serial))
  end
